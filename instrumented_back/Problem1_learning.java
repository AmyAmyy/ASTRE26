...
public class Problem1 implements CallableTraceRunner<Void> {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LearningTracker.run(eca.inputs, eca);
    }
